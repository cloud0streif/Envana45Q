...
interface CapturePlantOutletDashboardProps {
  embedded?: boolean
}

export function CapturePlantOutletDashboard({ embedded = false }: CapturePlantOutletDashboardProps = {}) {
  ...
  const chartData = useMemo(() => {
    ...
    const timeSeriesData = generateOutletTimeSeries(days)
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Capture Plant Outlet</h1>
          <p className="text-gray-600 mt-1">Where CO₂ exits the capture facility</p>
        </div>
        {!embedded && (
